...
public class BillWebController {
    ...
    @GetMapping("/")
    public ResponseEntity<List<Bill>> getCallsBetweenDates(@RequestHeader("Authorization") String token, @RequestParam(required = false, value = "from") String from, @RequestParam(required = false, value = "to") String to) throws ParseException {
